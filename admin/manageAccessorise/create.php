...
<body id="page-top">
    ...
    if (!move_uploaded_file($_FILES["img-url"]["tmp_name"], $target_banner)  ) {
     ...
     if($error==1){
        ...
        $sql = "INSERT INTO `tbl_acesstory`(`TenSp`, `BrandId`, `LoaiSp`, `XuatXu`, `HinhAnh`, `Gia`, `SoLuong`) 
                VALUES ('".$name."','".$brand."','".$type."','". $place ."','".$img ."','".$price."','".$amount."') ";
         $result = mysqli_query($conn,$sql);
         header("location:http://localhost/solar2/carShop/admin/manageAccessorise/index.php?message=create");
        }
    }
...
<div class="container-fluid">
    <div class="card shadow mb-4 ">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Thêm linh kiện </h6>
        </div>
        <div class="card-body">
           ...
           <div class="d-flex align-items-start">
               ...
               <div >
                ...
                <div class="info-container">
                    <div >
                            ...
                            <input class="form-control" name="TenSp" type="text" placeholder="Điền tên linh kiện...">
                        </div>
                        ...
                        <div>
                            ...
                            <select class="select-sort" name="LoaiSp" id="">
              ...
              <div >
                   <h6> Số lượng (Chiếc) <?php echo ' <span style="color:red">*</span>' ?></h6>
                    <input class="form-control" type="number" placeholder="Điền số lượng linh kiện" min="0" name="SoLuong">
