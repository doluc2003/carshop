        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php
                    if (!isset ($_GET["page"]) ) {
                        ...
                        $sql ="select * from tbl_acesstory";
                        if(isset($_GET["search"])){
                            $sql ="select * from tbl_acesstory where TenSp like '%".$_GET["search"]."%'";
                        }
            ...
            <div class="card shadow mb-4 ">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">DANH SÁCH LINH KIỆN</h6>
                    </div>
                    <div class="card-body">
                    ...
                    <a href="http://localhost/solar2/carShop/admin/manageAccessorise/create.php" class="btn btn-success">Thêm linh kiện</a>
                        </div>
                    <table class="table">
                        <thead>
                            <tr>
                            <th style="text-align: center;" scope="col">STT</th>
                            <th style="text-align: center;" scope="col">Tên linh kiện</th>
                    ...
                    function currency_format($number, $suffix = ' <sup style="color: black;">vnđ</sup>') {
                        if (!empty($number)) {
                            return number_format($number, 0, ',', '.') ;
                                 ...
                                 $sql = "SELECT a.ID, a.TenSp as name ,a.SoLuong,b.name as brand ,a.XuatXu,a.Gia,c.name  as type  FROM tbl_acesstory a
                                 ...
                                 if(isset($_GET["search"])){
                                    ...
                                    where a.TenSp like '%".$_GET["search"]."%'
                                    LIMIT ". $page_first_result ."," . $results_per_page;
                                 }
                                 ...
                                 if(mysqli_num_rows($car) >0 ){
                                    while($row = mysqli_fetch_assoc($car)){
                                        ...
                                        echo'<td style="text-align:right">'.currency_format($row["Gia"]).'</td>';
                                        echo'  <td style="text-align: center;">';
                                        echo'<a href="./up-date.php?id='.$row["ID"].'" class="btn btn-primary">sửa</a>';
