...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <?php
                     ...
                     $sql = "select * from`tbl_exterior` where Id =".$id." ";
    ...
    $isimg = move_uploaded_file($_FILES["img-url"]["tmp_name"], $target_img);
     if($error==1){
        $sql="UPDATE `tbl_exterior` SET `name`='".$name."',`BrandId`='".$brand."',`carId`='".$car."',`country`='".$place."',`price`='".$price."',`amount`='".$amount."',`decription`='".$description."' WHERE Id = ".$_GET["id"];
        if ( $isimg){           
            $sql="UPDATE `tbl_exterior` SET `name`='".$name."',`BrandId`='".$brand."',`carId`='".$car."',`country`='".$place."',`price`='".$price."',`amount`='".$amount."',`img`='".$img."',`decription`='".$description."' WHERE Id = ".$_GET["id"];
        }
       
        $conn = mysqli_connect('localhost','root','','carshop');
         $result = mysqli_query($conn,$sql);
         header("location:http://localhost/solar2/carShop/admin/manageExtendor/index.php?message=update");
        }
    }
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        ...
        <div class="card-body">
           ...
           <div class="d-flex align-items-start">
                <div>
                <h6>Ảnh ngoại thất <?php echo ' <span style="color:red">*</span>' ?></h6>
               ...
               <div >
                ...
                <div class="info-container">
                    <div >
                            ...
                            <input class="form-control" name="TenSp" type="text" value="<?php echo $name?>" placeholder="Điền tên sản phẩm...">
                        </div>
                        ...
                        <div>
                            ...
                            <select class="select-sort" name="Xe" id="">
           ...
           <h6>Mô tả <?php echo ' <span style="color:red">*</span>' ?></h6>
            <textarea placeholder="vd: Sang trọng quý phái,..." class="form-control" name="decription"  name="" id="" cols="80" rows="4"><?php echo $decription?></textarea>
      </div>
                    <div>
              ...
              <div >
                   <h6> Số lượng (Chiếc) <?php echo ' <span style="color:red">*</span>' ?></h6>
                    <input class="form-control" type="number" value="<?php echo $amount?>" placeholder="Điền số lượng " min="0" name="SoLuong">
