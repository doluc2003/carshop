                ...
                <?php
                    if (!isset ($_GET["page"]) ) {
                        ...
                        if(isset($_GET["search"])){
                            $sql ="select * from tbl_car where name like '%".$_GET["search"]."%'";
                        }
            ...
            <div class="card shadow mb-4 ">
                    ...
                    <table class="table">
                        <thead>
                            ...
                            <th style="text-align: center;" scope="col">Tên xe</th>
                            <th style="text-align: center;" scope="col">Xuất xứ</th> 
                            <th style="text-align: center;" scope="col">kiểu dáng</th>
                    ...
                    function currency_format($number, $suffix = ' <sup style="color: black;">vnđ</sup>') {
                        if (!empty($number)) {
                            return number_format($number, 0, ',', '.') ;
                                 ...
                                 $sql = "SELECT c.id,c.name as name , c.amount,b.name as brand ,c.seats,c.country,c.price,m.name  as model 
                                 FROM tbl_car c
