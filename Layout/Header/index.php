...
<body>
    ...
    <header class="header-container">
        ...
        <ul class="nav-container">
            ...
            <li class="<?php if($page =='Home'){echo 'nav-content active'; }else {echo 'nav-content ';}?>"><a href="" class="nav-child">Mua Linh Kiện</a></li>
            <li class="<?php if($page =='Home'){echo 'nav-content active'; }else {echo 'nav-content ';}?>"><a href="" class="nav-child">Tin Tức</a></li>
        </ul>
